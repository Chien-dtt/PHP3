...
<head>
    ...
    <style>
        ...
        * {
        ...
        .tooltip::after {
            content: "Email or Password wrong!⚠️";
            display: inline-block;
            position: absolute;
            width: 100%;
            height: 100%;
        ...
        .tooltip-container:hover .tooltip::after {
            animation: hidden 1s 1.5s linear forwards;
        }
...
<body>
    <section>
        ...
        <form onsubmit="test()" action="{{ route('postLogin') }}" class="login" method="post">
            @csrf
            <h2>Login</h2>
            @if (session('messageError'))
                <div class="tooltip-container">
                    <span class="tooltip">Please. Check your account !!!</span>
                    <span class="text">Có lỗi xảy ra !</span>
                    <svg id="Calque_1" viewBox="0 0 377 270" xmlns="http://www.w3.org/2000/svg">
                        <g id="phone">
                            <g id="caractere_x5F_1">
                              ...
                              c0,0,17.8,28.2,42,18.3C217.2,118.7,204.4,102.4,199,87.1z"></path>
                                  ...
                                  c0.6-0.3,1.3-0.4,2-0.3C184.2,61.7,185.5,62.5,186,63.8z"></path>
                                        <path id="eye_x5F_left" class="st5"
                              ...
                              C173.4,48.2,171.3,32.2,171.3,32.2z"></path>
                                    ...
                                    <ellipse id="left_x5F_cheek_2_"
                                        ...
                                        class="st8" cx="160.2" cy="67.9" rx="1.3" ry="3.7">
                                    </ellipse>
                          ...
                          C132.5,35.9,144.9,22.1,158.6,21.9z"></path>
                                <ellipse class="st15" cx="127.2" cy="65.8" rx="4.1"
                                    ry="12.4"></ellipse>
                            </g>
                        </g>
                    </svg>
            ...
            @endif
            <div class="inputBox">
                <input class="field" type="text" placeholder="Email" name="email" id="email">
                @error('email')
                    <div class="tooltip-container">
                        <span class="tooltip-1">{{ $message }}</span>
                        <span>Lỗi Email</span>
                    </div>
                @enderror
            ...
            <div class="inputBox">
                ...
                @error('password')
                    <div class="tooltip-container">
                        <span class="tooltip-1">{{ $message }}</span>
                        <span>Lỗi Password</span>
                    </div>
                @enderror
            </div>
            <div class="inputBox">
                <input class="submit" type="submit" value="Login" id="btn">
            </div>
            <div class="group">
